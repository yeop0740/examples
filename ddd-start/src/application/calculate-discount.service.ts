import {DroolsRuleEngine, DroolsRuleEngineLegacy} from "../infra/drools-rule-engine";
import {OrderLine} from "../order-line";
import {MutableMoney} from "../mutable-money";
import {RuleDiscounter} from "../infra/rule-discounter.interface";
...
export class CalculateDiscountService {
    ...
    constructor(ruleEngine: RuleDiscounter, customerRepository: CustomerRepository) {
        this.#ruleEngine = ruleEngine;
