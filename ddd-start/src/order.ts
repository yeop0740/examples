...
export class Order {
    ...
    constructor(orderNumber: OrderNumber, orderLines: OrderLine[], orderer: Orderer, shippingInfo: ShippingInfo) {
    ...
    changeShippingInfo(newShipping: ShippingInfo, userNewShippingAddrAsMemberAddr: boolean): void
    // 애그리거트 루트는 도메인 규칙을 구현한 기능을 제공한다.
    changeShippingInfo(newShipping: ShippingInfo, userNewShippingAddrAsMemberAddr?: boolean) {
        this.#verifyNotYetShipped();
        // null case 체크해야하나?
